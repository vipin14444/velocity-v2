...
const callReducer = (callState, action) => {
    switch (action.type) {
...
const getLocalCallItem = (callItems) => {
    return callItems["local"];
};

const getCallItems = (participants) => {
...
const shouldIncludeScreenCallItem = (participant) => {
...
const isScreenShare = (id) => {
    return id.endsWith("-screen");
};

const containsScreenShare = (callItems) => {
